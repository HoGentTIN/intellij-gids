...
> ⚠️ Als `pom.xml` niet aanwezig is, volg dan de stappen onder [Een bestaand Eclipse-project of een src-map openen](/intellij-gids/eclipse-project-openen/eclipse-project-openen.html).
