...
Maak een nieuwe folder, bv. `Documenten\OOSDII\intellij-workspace-2526`, die je als workspace zal gebruiken. Bedoeling is om je nieuwe aangemaakte projecten en/of startprojecten hierin op te slaan.  Zo zijn alle projecten samen gegroepeerd en makkelijk terug te vinden. Je kan eventueel nog een verdere indeling per hoofdstuk maken.
